...
-- answer를 correct_answer로 변경 (이미 있으면 무시)
DO $$ 
BEGIN
...
-- correct_answer 컬럼이 없으면 추가
ALTER TABLE blocks ADD COLUMN IF NOT EXISTS correct_answer TEXT;

-- 2. folders 테이블 생성 (없으면)

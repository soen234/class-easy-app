...
-- 6. materials 테이블 생성 (folders 테이블이 생성된 후)
...
-- 11. blocks 테이블의 material_id 외래키 추가 (materials 테이블이 생성된 후)
DO $$
BEGIN
  IF NOT EXISTS (
